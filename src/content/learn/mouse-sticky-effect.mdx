...
<div className={classes.imageContainer}>
  ...
  3](../../images/blog/learn/mouse-sticky-effect/description-image-1.jpg)
</div>
...
<div className={classes.imageContainer}>
  ...
  3](../../images/blog/learn/mouse-sticky-effect/description-image-2.jpg)
</div>

위 그림은 실제 커서를 움직인 순간의 장면이다.
검은색 원은 표시 커서다.
X축 식과 Y축 식이 X축인지 Y축인지 구분하는 표현만 제외하면 동일하므로 Y축 식은 생략했다.
...
즉, 이 계수 값이 올라갈수록 표시 커서가 실제 커서를 천천히 따라가게 된다.
...
<div className={classes.imageContainer}>
  ...
  3](../../images/blog/learn/mouse-sticky-effect/description-image-3.jpg)
</div>
...
3번, 묙표 요소의 자식 요소는 transform 값을 0으로 만들어주면 된다. 원래 위치가 목표 요소의 정중앙이기 때문이다.
